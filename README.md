...
4. **Fuse** the CNN classification with the RCNN's own label prediction
5. **Delineate** the nodule boundary using a Greedy Snake active contour
6. **Display** all results in a Streamlit web UI with annotated images and confidence scores
